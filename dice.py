...
class Dice:
    ...
    def __init__(self, x, y, size):
        self.face = ['dice/diceOne.png','dice/diceTwo.png','dice/diceThree.png','dice/diceFour.png','dice/diceFive.png','dice/diceSix.png'] #array to hold images for dice faces
        self.d1X = x
        self.d1Y = y
        self.size = size
